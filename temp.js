...
function initEnv() {
    ...
    // Generate Voice UEs (small packets)
    for (let i = 0; i < NUM_VOICE_UE; i++) {
        ues.push({
            id: `V${i}`,
            x: randomInt(25, AREA_SIZE - 25),
            y: randomInt(25, AREA_SIZE - 25),
            type: "VOICE",
            packet: randomInt(3, 10),
            transmitted: false
        });
    }

    // Generate MBB UEs (large packets)
